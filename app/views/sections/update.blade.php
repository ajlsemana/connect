...
<div class="widget">
    ...
    <div class="widget-content">
    	{{ Form::model($section, array('url'=>'admin/sections/updateData', 'class'=>'form-horizontal', 'id'=>'form-sections', 'role'=>'form', 'method' => 'post')) }}
		<div class="span3">&nbsp;</div>
		<div class="span7">
			<fieldset>
				<div class="control-group">											
					...
					<div class="controls">
						{{ Form::select('semester', $semester_options, $section->semester, array('id'=>'semester')) }}
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
				...
				<div class="control-group">											
					...
					<div class="controls">
						{{ Form::text('code', $section->code, array('maxlength'=>'50')) }}
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->							
				...
				<div class="control-group">											
					...
					<div class="controls">
						{{ Form::text('school_year_from', $section->school_year_from, array('class'=>'date', 'maxlength'=>'10', 'style'=>'width: 50px;')) }}
						-
						{{ Form::text('school_year_to', $section->school_year_to, array('class'=>'date', 'maxlength'=>'10', 'style'=>'width: 50px;')) }}
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->			
