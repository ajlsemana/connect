                  ...
                  <div class="row">
                     <div class="span12">
                        ...
                        <div class="table-responsive">
                           {{ Form::open(array('url' => 'trainee/lectureWall', 'files' => true, 'class'=>'form-horizontal', 'autocomplete'=>'off', 'id'=>'form-post', 'role'=>'form', 'method' => 'post')) }}
                           ...
                           {{ Form::hidden('status', (isset($_GET['status']) ? 'attended' : '')) }}    		    		    
                           <br />
   	...
   	$('.bottom-wall-delete').click(function(e) {
   		...
   		if(con) {
   			$.ajax({
   			  type: 'GET',
   			  dataType: 'json',
   			  url: '{{ URL::to("trainee/deleteComment") }}',
   			  data: 'cid='+ sp[3]
   			}).success(function( data ) {					
   				if(data.cid) {		
   ...
   function updateComment(id) {		
   		...
   		if(txtComment == '') {
   			...
   			$.ajax({
   			  type: 'GET',
   			  dataType: 'json',
   			  url: '{{ URL::to("trainee/updateComment") }}',
