		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">New Assigment</div>
					<div class="panel-body">
						{{ Form::open(array('url' => $url_class . '/addAssignment', 'files' => true, 'class'=>'form-horizontal', 'autocomplete'=>'off', 'id'=>'form-post', 'role'=>'form', 'method' => 'post')) }}
