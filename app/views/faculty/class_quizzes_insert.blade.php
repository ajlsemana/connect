...
<div class="widget">
   <div class="widget-header">
      ...
      <h3>{{ $course->name }} New Assignment</h3>
   </div>
                     ...
                     <div class="span12">
                        ...
                        <div class="panel panel-default">                           
                           <div class="panel-body">
                              {{ Form::open(array('url' => 'trainer/quizzes/addQuiz', 'class'=>'form-horizontal', 'autocomplete'=>'off', 'id'=>'form-post', 'role'=>'form', 'method' => 'post')) }}
                              ...
                              <div class="control-group">
                                 ...
                                 <div class="span7">
                                    {{ Form::textarea('description', Input::old('description'), array('size' => '60x10', 'class' => 'form-control', 'id'=> 'description', 'maxlength' => 5000, 'style' => 'width: 550px;')) }}
                                 </div>
                              </div>
                              <div class="control-group">
                              ...
                              <div class="control-group" id="answer_{{ $counter }}">
                                 ...
                                 <div class="span7">
                                    ...
                                    <div style="clear: both; padding-bottom: 10px;" align="left">
                                       <a href="#" class="btn btn-primary deleteQuestion" data-id="{{ $counter }}">Delete Question</a>
                                    </div>
                                    @endif
                                 </div>
                              </div>
                              ...
                              {{ Form::hidden('cid', Input::segment(4)) }} 
                              {{ Form::close() }}	
                           </div>
                        </div>
                     </div>
