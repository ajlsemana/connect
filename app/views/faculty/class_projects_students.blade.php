					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $student->grade }}</td>
								<td>
									<a data-toggle="modal" data-target="#viewModal" data-id="{{ $student->ps_id }}" class="view glyphicon glyphicon-folder-open" style="cursor: pointer;" title="View Notes and Files"></a>&nbsp;&nbsp;
									<a data-toggle="modal" data-target="#gradeModal" data-id="{{ $student->ps_id }}" data-points="{{ $student->points }}" class="grade glyphicon glyphicon-stats" style="cursor: pointer;" title="Set Grade"></a>
								</td>
							</tr>
							@endforeach
							@else
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <div class="modal-body">
		...
		{{ Form::hidden('ps_id', '', array('id' => 'g_ps_id')) }}
...
$(document).ready(function() {
    ...
    $('.view').click(function() {
    	...
    	$.ajax({
			url: '{{ $url_class . '/projects/students/getDetails' }}',
			type: 'GET',
			dataType: 'json',
