...
<div class="tab-content">
	<div class="tab-pane active" id="projects">
		<div class="row">
	    	<div class="col-sm-12">
	    		<div align="left">
	    			<a href="{{ $url_insert }}" class="btn btn-primary" title="Add New Project">Add New Project</a>
	    		</div>
	    		<br />
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ (date('Y-m-d') <= $project->due_date) ? 'Open' : 'Closed' }}</td>
								<td>
								...
								<td>
									...
									@if (date('Y-m-d') <= $project->due_date)
									<a href="{{ $url_class . '/projects/update?id=' . $project->id }}" class="glyphicon glyphicon-pencil" title="Update"></a>&nbsp;&nbsp;
									@endif
									<a href="#" data-id="{{ $project->id }}" class="delete glyphicon glyphicon-trash" title="Delete"></a>&nbsp;&nbsp;
									<a href="{{ $url_class . '/projects/students?id=' . $project->id }}" class="glyphicon glyphicon-user" title="Students"></a> 
								</td>
							</tr>
							@endforeach
							@else
...
$(document).ready(function() {
	...
	$('.delete').click(function() {
		if (confirm('Delete Project?')) {
			...
			location.href = "{{ $url_class . '/projects/delete?id=' }}" + id;
		} else {
			return false;
		}
	});
