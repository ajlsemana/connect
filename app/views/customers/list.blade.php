...
<div align="left" style="padding-bottom: 15px;">
   <a href="{{ $url_insert }}" class="btn btn-primary">Add New Customer</a>
			...
			<tbody>
				...
				<tr align="center">
					...
					<td>
					   ...
					   @if($company->logo != '')					   
					   {{ HTML::image(Config::get('app.url_storage') . '/company_logo/'.$company->logo, 'logo', array('style' => 'width: 80px; height: ;', 'class' => '')) }}  
					   @else						
