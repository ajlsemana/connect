...
<div class="widget">
    ...
    <div class="widget-content">
    	{{ Form::model($attendees[0], array('url'=>'admin/attendees/updateData', 'class'=>'form-horizontal', 'id'=>'form-users', 'role'=>'form', 'method' => 'post')) }}
    	<div class="container">
    		<div class="row">
				<div class="span4">
						...
						<div class="control-group">											
							...
							<div class="controls">
								...
								{{ Form::hidden('primary_email_address', $attendees[0]->primary_email_address, array('id' => 'primary-email')) }}
							</div> <!-- /controls -->				
						</div> <!-- /control-group -->	
						...
						<div class="control-group">											
							...
							<div class="controls">
								{{ $attendees[0]->name }}
								{{ Form::hidden('my_course', $attendees[0]->name, array('id' => 'my-course') ) }}								
							</div> <!-- /controls -->				
						</div> <!-- /control-group -->
						...
						@if($attendees[0]->change_status != 'Confirmed')
						<div class="control-group">																		
							<div class="controls">									
								<a href="#" data-id="{{ $_GET['id'] }}" class="btn btn-primary" id="confirmBtn">Confirm Attendance</a>
							</div> <!-- /controls -->				
						</div> <!-- /control-group -->													
						@endif
		        </div>
		        <div class="span4">
		        	...
		        	<!--<a href="{{ URL::to('admin/attendees/listing-info/'.$attendees[0]->rid) }}">[ Summary Report of {{ $attendees[0]->first_name.' '.$attendees[0]->last_name }} ]</a>-->
		        	<div class="control-group">											
		        	...
		        	<div class="control-group">											
						...
						<div class="controls">
							{{ Form::select('reference', array('' => '- Please Select -', 'POP' => 'POP', 'with PO' => 'with PO'), null, array('id'=>'reference')) }}
						</div> <!-- /controls -->				
					</div> <!-- /control-group -->
					...
					<div class="control-group">											
						...
						<div class="controls">
							<?php
								...
								endswitch;																		
							?>	
							<input type="text" name="confirmed_date" value="{{ $training_date }}" readonly>						
					...
					?>
					<hr>
					@if(in_array(Auth::user()->username, array('joseph.semana@bluemena.com', 'michelle.rodriguez@bluemena.com', 'ahmer.jalal@bluemena.com')))
					<b>Step 1:</b>
					<div class="control-group">											
...
$(document).ready(function() {
	...
	$('#confirmBtn').click(function() {
		...
		if (confirm('Are you sure you want to confirm attendance?')) {
    		window.location.href = '{{ URL::to("admin/users/confirmAttendance?id=") }}'+id+'&email='+email+'&course='+course;
    	}
    });
