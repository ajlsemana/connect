...
<div id="skill-container">
   ...
   {{ HTML::script('resources/js/tinymce/tinymce.min.js') }}   
            ...
            <table class="table" style="background: #FFF;" height="400">
               <thead>
                  <tr align="center" style="background: #9FA7B4;">
                     <th colspan="2"> <a href="#viewFeedbacksModal" style="color: #FFF;" data-toggle="modal">No. of Feedbacks ( <span id="span-no-feedback">{{ $no_of_feedbacks }}</span> )</a> <span style="float: right;"><a href="#feedbackModal" style="color: #FFF;" data-toggle="modal"><i class="icon-large icon-plus" title="add feedback"></i></a></span></th>
                  </tr>
               </thead>
               <tbody>
                  <tr id="tr-feedback">
   ...
   <div id="feedbackModal" style="left: 37%; overflow-y: auto; width: 70%;"  class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
         <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
         {{ HTML::script('resources/js/ddslick.js') }}     
         {{ Form::open(array('url'=>'admin/skills-map/send-survey', 'class'=>'form-horizontal', 'autocomplete'=>'off', 'id'=>'form-feedback', 'role'=>'form', 'method' => 'post')) }}
         <table style="font-size: 13px; width: 99%;" cellpadding="10">
            ...
            <tr>
               <td colspan="2" align="center"><input type="submit" id="submit-feedback" style="background: #2c6b00;" class="btn btn-primary" value="Send"> <a data-dismiss="modal" aria-hidden="true" class="btn" onclick="document.getElementById('form-feedback').reset();">Cancel</a>  </td>
            </tr>
         </table>
         {{ Form::close() }}
         <script>
            ...
            //Auto resize textarea when bumped to the last right
