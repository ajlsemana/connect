...
<div align="left" style="padding-bottom: 15px;">
	...
	<a href="{{ $url_insert_cost }}" class="btn btn-primary">Update Cost</a>
...
<div class="widget">
	<div class="widget-header">
		<i class="icon-user"></i>
		<h3>Attendees for <u>{{ strtoupper($full_course) }}</u></h3>
...
$(document).ready(function() {
    ...
    $('#clearForm').click(function() {
    	location.href = "{{ URL::to('admin/attendees/temp-listings/'.$specific_course) }}";
    });
