   ...
   <div class="span12">
      <div class="widget">
         ...
         <div class="widget-content">
            &nbsp;&nbsp;&nbsp;{{ Form::model($user, array('url'=>'user/updateProfile', 'files' => true, 'class'=>'form-horizontal', 'id'=>'form', 'role'=>'form', 'method' => 'post')) }}	
            <div class="control-group">
               ...
               <div class="col-sm-4">
                  ...
                  @endif	
                  &nbsp;&nbsp;&nbsp;		
                  <img height="240" width="240" class="img-responsives" src="{{ $destinationPath }}" />			
                  <br /><br />
                  &nbsp;&nbsp;&nbsp;{{ Form::file('image') }}	
               </div>
            </div>
