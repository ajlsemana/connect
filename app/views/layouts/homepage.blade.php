   ...
   <html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
	  ...
	  <?php endif; ?>
               ...
               <div class="h-header__block--bg small-12 medium-7 columns">
                  <nav class="h-header__nav-wrap">
                     <ul class="h-nav--main -nav-hairline--down">
                        ...
                        <li class="h-nav__entry {{ ($route == 'workshops' || $route == 'technical' || $route == 'script' || $route == 'inbound' || $route == 'outbound' || $route == 'contact_center') ? '-is_active' : '' }}">
                           <a href="{{ URL::to('workshops') }}" class="h-nav__link">Trainings</a>
                        </li>
						<li class="h-nav__entry {{ ($route == 'registration') ? '-is_active' : '' }}">
                           <a href="{{ URL::to('registration') }}" class="h-nav__link">Registration</a>
                        </li>
         ...
         <header class="h-header -has-subnav">
                     ...
                     <h2 class="h-header__title">
                        <?php
                           if($route == 'history' || $route == 'chairman') {
                           	 ...
                           	 echo 'Services';
                           } elseif($route == 'workshops' || $route == 'technical' || $route == 'script' || $route == 'inbound' || $route == 'outbound' || $route == 'contact_center') {
                           	 echo 'Trainings';
                           } elseif($route == 'login') {
                               echo 'Welcome to BMG';
                           } else {
                  ...
                  <ul class="h-nav--subnav -nav-hairline--up small-12 js-collapsible">
                     ...
                     <li class="h-nav__entry -collapsed js-collapsed" style="display: none;">
                        <ul id="subnav_collapsed" class="h-dd f-dropdown" data-dropdown-content="">
                           ...
                           <li class="h-dd__entry {{ ($route == 'workshops' ? '-is_active' : '') }}" data-id="js-dden1" style="display: none;">
                              <a href="{{ URL::to('workshops') }}" class="h-dd__link">Trainings</a>
                           </li>
            ...
            <?php elseif($route == 'workshops' || $route == 'technical' || $route == 'script' || $route == 'inbound' || $route == 'outbound' || $route == 'contact_center'): ?>
            <nav class="h-header__subnav-wrap">
               <div class="row collapse">
                  <ul class="h-nav--subnav -nav-hairline--up small-12 js-collapsible">
					 ...
					 <li class="h-nav__entry {{ ($route == 'workshops' ? '-is_active' : '') }}" data-id="js-dden1">
                        <a href="{{ URL::to('workshops') }}" class="h-nav__link--sub">Workshops</a>
                     </li>
                     ...
                     <li class="h-nav__entry -collapsed js-collapsed" style="display: none;">
                        <ul id="subnav_collapsed" class="h-dd f-dropdown" data-dropdown-content="">
						   ...
						   <li class="h-dd__entry {{ ($route == 'workshops' ? '-is_active' : '') }}" data-id="js-dden1" style="display: none;">
                              <a href="{{ URL::to('workshops') }}" class="h-dd__link">Workshops</a>
                           </li>
               ...
               <nav class="h-menu__container">
                  <div class="h-menu__main-level">
                     ...
                     <ul class="h-menu__list">
						...
						<li>
						   <a href="#" class="h-menu__link h-menu__link--next -white {{ ($route == 'workshops' ? '-trail' : '') }}">
						   Trainings
						   <span class="h-icon--small -icon-arrow-right h-menu__icon-n -icon-white" style="background-image: none;">                       
						   <i class="step fi-arrow-right size-24"></i>
						   </span>
						   </a>
						   <div class="h-menu__level {{ ($route == 'workshops' || $route == 'technical' || $route == 'script' || $route == 'inbound' || $route == 'outbound' || $route == 'contact_center' ? 'js-level-open' : '') }} ">
							  <div class="h-menu__actions">
								 <a href="#" class="h-menu__back">
								 <span class="h-icon--small h-menu__icon-back -icon-arrow-left" style="background-image: none;">                  
								 <i class="step fi-arrow-left size-24"></i>
							  ...
							  <ul class="h-menu__list">
								 ...
								 <li>
									<a href="{{ URL::to('workshops') }}" class="h-menu__link {{ ($route == 'workshops' ? '-trail' : '') }} ">Workshops</a>
								 </li>
								 <li>
						...
						<li>
                           <a href="{{ URL::to('registration') }}" class="h-menu__link  -white">Registration</a>
                        </li>
                        <li>
