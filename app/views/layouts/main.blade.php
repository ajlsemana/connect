         ...
         <div class="subnavbar-inner">
            <div class="container">
               <ul class="mainnav">
                  ...
                  <li class="@if (in_array($route, array('admin/skills-map', 'admin/skills-map/update', 'admin/skills-map-v7', 'admin/skills-map-v7/update'))) active @endif"><a href="{{ URL::to('admin/skills-map') }}"><i class="icon-bar-chart"></i><span>Engineer Profiles</span> </a> </li>
				  ...
				  <li class="dropdown @if (in_array($route, array('admin/customers', 'admin/company', 'admin/company-internal', 'admin/company-internal/add', 'admin/company-internal/update', 'admin/company/add', 'admin/company/update', 'admin/customers/add', 'admin/customers/update'))) active @endif">
                     <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> 
                     <i class="icon-briefcase"></i><span>Companies</span> <b class="caret"></b></a>
                     <ul class="dropdown-menu">
                        <li><a href="{{ URL::to('admin/company') }}">Service Providers</a></li>
                        <li><a href="{{ URL::to('admin/customers') }}">Customers</a></li>
                        <!--<li><a href="{{ URL::to('admin/company-internal') }}">Internal Companies</a></li>-->
                     </ul>
                  </li>
