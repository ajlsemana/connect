...
<div class="widget">
    ...
    <div class="widget-content">
    	{{ Form::model($announcement, array('url'=>'admin/announcements/updateData', 'class'=>'form-horizontal', 'id'=>'form-announcements', 'role'=>'form', 'method' => 'post')) }}
		<div class="span3">&nbsp;</div>
		<div class="span7">
			<fieldset>
				<div class="control-group">											
					...
					<div class="controls">
						{{ Form::text('title', $announcement->title, array('maxlength'=>'255')) }}
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
				...
				<div class="control-group">											
					...
					<div class="controls">
						{{ Form::textarea('content', $announcement->content, array('id'=>'editor', 'style'=>'width: 400px; height: 200px;')) }}
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
				...
				<div class="control-group">											
					...
					<div class="controls">
						{{ Form::text('date_from', $announcement->date_from, array('class'=>'date', 'maxlength'=>'10', 'style'=>'width: 100px;')) }}
						<br />
				...
				<div class="control-group">											
					...
					<div class="controls">
						{{ Form::text('date_to', $announcement->date_to, array('class'=>'date', 'id'=>'date_to', 'maxlength'=>'10', 'style'=>'width: 100px;')) }}
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
